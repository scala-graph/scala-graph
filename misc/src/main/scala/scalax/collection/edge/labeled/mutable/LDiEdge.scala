...
import scalax.collection.OuterImplicits._, scalax.collection.generic._.{DiEdge, NodeProduct}
import scalax.collection.Graph

/** Type-safe directed labeled edge with a mutable label.
  *  @author Peter Empen
  */
class LDiEdge[+N, @specialized L](nodes: Product)(private var _label: L) extends DiEdge[N](nodes) {
...
object LDiEdge {
  ...
  implicit final class Assoc[N](val n1: N) extends AnyVal {
