...
package object json {
  ...
  type  WEdgeDescriptor[N,E[X]<:UnDiEdge[X] with  WEdge[X],+C<: WEdgeCompanion[E]]           = descriptor. WEdgeDescriptor[N,E,C] 
  type  LEdgeDescriptor[N,E[X]<:UnDiEdge[X] with  LEdge[X],+C<: LEdgeCompanion[E],L<:AnyRef] = descriptor. LEdgeDescriptor[N,E,C,L] 
  type WLEdgeDescriptor[N,E[X]<:UnDiEdge[X] with WLEdge[X],+C<:WLEdgeCompanion[E],L<:AnyRef] = descriptor.WLEdgeDescriptor[N,E,C,L] 
