...
trait GraphConstrainedCompanion[+GC[N, E[X] <: EdgeLike[X]] <: Graph[N, E] with GraphLike[N, E, GC]]
  ...
  protected[collection] def fromUnchecked[N, E[X] <: EdgeLike[X]](nodes: Traversable[N], edges: Traversable[E[N]])(
      implicit edgeT: ClassTag[E[N]],
      config: Config): GC[N, E]
  override def newBuilder[N, E[X] <: EdgeLike[X]](implicit edgeT: ClassTag[E[N]],
                                                    config: Config): Builder[Param[N, E], GC[N, E]] =
    new GraphBuilder[N, E, GC](this)(edgeT, config)
}

abstract class GraphConstrainedCompanionAlias[GC[N, E[X] <: EdgeLike[X]] <: Graph[N, E] with GraphLike[N, E, GC],
                                              E[X] <: EdgeLike[X]](
...
trait MutableGraphCompanion[+GC[N, E[X] <: EdgeLike[X]] <: mutable.Graph[N, E] with mutable.GraphLike[N, E, GC]]
...
trait ImmutableGraphCompanion[+GC[N, E[X] <: EdgeLike[X]] <: immutable.Graph[N, E] with GraphLike[N, E, GC]]
    extends GraphConstrainedCompanion[GC]
