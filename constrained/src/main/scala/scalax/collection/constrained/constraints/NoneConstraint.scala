...
/** The empty constraint treating any addition or subtraction as valid.
  */
class NoneConstraint[N, E[X] <: EdgeLike[X]](override val self: Graph[N, E]) extends Constraint[N, E](self) {
...
object NoneConstraint extends ConstraintCompanion[NoneConstraint] {
  def apply[N, E[X] <: EdgeLike[X]](self: Graph[N, E]) = new NoneConstraint[N, E](self)
}
