...
/** The empty constraint treating any addition or subtraction as valid.
  */
class NoneConstraint[N, E <: Edge[N], G <: Graph[N, E]](override val self: G) extends Constraint[N, E, G](self) {
...
object NoneConstraint extends ConstraintCompanion[NoneConstraint] {
  def apply[N, E <: Edge[N], G <: Graph[N, E]](self: G) = new NoneConstraint[N, E, G](self)
}
