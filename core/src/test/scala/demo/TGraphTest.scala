...
object TGraphTest extends App {
  ...
  object PersonData {
    val firstNames     = Set("Alen", "Alice", "Bob", "Jack", "Jim", "Joe", "Kate", "Leo", "Tim", "Tom").to(Vector) // TODO why?
    val firstNamesSize = firstNames.size

    val surnames     = Vector("Bell", "Brown", "Clark", "Cox", "King", "Lee", "Moore", "Ross", "Smith", "Wong").to(Vector) // TODO why?
