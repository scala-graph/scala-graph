...
/**	This trait extends the inner node type of Graph by inheritance.
  ...
  */
trait MyExtGraphLike[
    N,
    E[X] <: EdgeLikeIn[X],
    +This[X, Y[X] <: EdgeLikeIn[X]] <: MyExtGraphLike[X, Y, This] with AnySet[Param[X, Y]] with Graph[X, Y]]
    extends GraphLike[N, E, This] { this: This[N, E] =>
...
package immutable {
  ...
  /** Custom immutable Graph based on the default implementation
    ...
    */
  class MyExtGraph[N, E[X] <: EdgeLikeIn[X]](iniNodes: Traversable[N] = Nil, iniEdges: Traversable[E[N]] = Nil)(
    ...
    @inline final override def clone = MyExtGraph.from[N, E](nodes.toOuter, edges.toOuter)
    @inline final override def copy(nodes: Traversable[N], edges: Traversable[E[N]]) =
  ...
  object MyExtGraph extends ImmutableGraphCompanion[MyExtGraph] {
    def empty[N, E[X] <: EdgeLikeIn[X]](implicit edgeT: ClassTag[E[N]], config: Config) = new MyExtGraph[N, E]
...
package mutable {
  ...
  /** The mutable variant of `MyExtGraph`.
    ...
    */
  class MyExtGraph[N, E[X] <: EdgeLikeIn[X]](iniNodes: Traversable[N] = Set[N](),
