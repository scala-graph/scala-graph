...
object Implicits {
  ...
  final class XHyperEdgeAssoc[NOld](e: EdgeLike[NOld]) {
    ...
    def ~%    [N >: NOld](n: N)(w: Double)(implicit endpointsKind: CollectionKind = Bag) =  WHyperEdge.from[N](product(e, n))(w)
    def ~%#   [N >: NOld](n: N)(w: Double)(implicit endpointsKind: CollectionKind = Bag) = WkHyperEdge.from[N](product(e, n))(w)
    ...
    def ~%+   [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) =   WLHyperEdge.from[N,L](product(e, n))(w, l)
    def ~%#+  [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) =  WkLHyperEdge.from[N,L](product(e, n))(w, l)
    def ~%+#  [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) =  WLkHyperEdge.from[N,L](product(e, n))(w, l)
    def ~%#+# [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) = WkLkHyperEdge.from[N,L](product(e, n))(w, l)
    
    def ~%>    [N >: NOld](n: N)(w: Double)(implicit targetsKind: CollectionKind = Bag)   =  WDiHyperEdge.from[N](product(e, n))(w)
    def ~%#>   [N >: NOld](n: N)(w: Double)(implicit targetsKind: CollectionKind = Bag)   = WkDiHyperEdge.from[N](product(e, n))(w)
    ...
    def ~%+>   [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) =   WLDiHyperEdge.from[N,L](product(e, n))(w, l)
    def ~%#+>  [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) =  WkLDiHyperEdge.from[N,L](product(e, n))(w, l)
    def ~%+#>  [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) =  WLkDiHyperEdge.from[N,L](product(e, n))(w, l)
    def ~%#+#> [N >: NOld, L](n: N)(w: Double, l: L)(implicit endpointsKind: CollectionKind = Bag) = WkLkDiHyperEdge.from[N,L](product(e, n))(w, l)
  }
