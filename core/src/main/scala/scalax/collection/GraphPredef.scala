...
object GraphPredef {
  ...
  @inline implicit def anyToNode[N](n: N): OuterNode[N] = new OuterNode(n)
}
...
abstract class AbstractEdgeImplicits[E[N] <: EdgeLike[N] with AbstractEdge[N], C <: EdgeCompanion[E]](companion: C) {
  trait AnyToEdge[N] extends Any {
    def n1: N
    def ~[NN >: N](n2: NN): E[NN] = companion(n1, n2)
  }
...
object UnDiEdgeImplicits extends AbstractEdgeImplicits[UnDiEdge, UnDiEdge.type](UnDiEdge) {
  implicit class AnyToEdge[N](override val n1: N) extends AnyVal with super.AnyToEdge[N]
}

abstract class AbstractDiEdgeImplicits[E[N] <: AbstractDiEdge[N], C <: EdgeCompanion[E]](companion: C) {
  trait AnyToEdge[N] extends Any {
    def source: N
...
object DiEdgeImplicits extends AbstractDiEdgeImplicits[DiEdge, DiEdge.type](DiEdge) {
  implicit class AnyToEdge[N](override val source: N) extends AnyVal with super.AnyToEdge[N]
}
